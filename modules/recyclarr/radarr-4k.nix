  ...
  assertions = [
    {
      ...
      message = "Recyclarr radarr-4k sync requires an API key";
    }
  ];
  nixflix.recyclarr.config.radarr.radarr-4k = lib.mkIf cfg.enable {
    ...
    quality_definition.type = lib.mkDefault "sqp-streaming";
